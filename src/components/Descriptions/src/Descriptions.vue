...
import { ref, unref, type PropType, computed, defineComponent } from 'vue'
        ...
        >
          {props.title ? (
            <div
              ...
              onClick={toggleClick}
            >
              <div class={[`descriptions-header__title`, 'relative font-18px font-bold ml-10px']}>
          ...
          <ElCollapseTransition>
            <div v-show={unref(show)} class={[`descriptions-content`, 'p-20px']}>
              <ElRow
                gutter={0}
                {...unref(getBindValue)}
