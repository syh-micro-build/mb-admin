...
import { radarOption } from '../Components/echarts-data'
        ...
        <ElRow :gutter="20" justify="space-between">
          <ElCol :xl="12" :lg="12" :md="12" :sm="24" :xs="24">
            <div class="flex items-center">
              ...
              />
              <div>
                <div class="text-20px">早安，ShanYi，祝你开心每一天!</div>
                <div class="mt-10px text-14px text-gray-500">今日晴，20℃ - 32℃！</div>
              </div>
            </div>
          </ElCol>
          <ElCol :xl="12" :lg="12" :md="12" :sm="24" :xs="24">
        ...
        <ElSkeleton :loading="loading" animated>
          <div v-for="(item, index) in dynamics" :key="`dynamics-${index}`">
            <div class="flex items-center">
              ...
              <div>
                <div class="text-14px">
                  <Highlight :keys="item.keys.map((v) => v)"> ShanYi 推送 代码到 Github </Highlight>
                </div>
        ...
        <ElSkeleton :loading="loading" animated>
          <ElRow>
            <ElCol
              ...
              class="mb-10px"
            >
              <ElLink type="default" :underline="false"> 操作{{ item }} </ElLink>
            </ElCol>
          </ElRow>
        </ElSkeleton>
      </ElCard>
